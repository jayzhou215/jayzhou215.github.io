...
## Queue
actions: Create & Peek & Push & Pop

Peek: get the element at head
Push: add an element at tail
Pop: remove an element at head

## Double Linked List
actions: Create & Search & Insert & Remove

Action:Search by Value
Action:Insert from head/i/tail
Action:Remove from head/i/tail

## DEQUE

Peek: get the element at head/tail
Push: add an element at tail/tail
Pop: remove an element at head/tail
